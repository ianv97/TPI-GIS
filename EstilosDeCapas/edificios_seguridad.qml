    ...
    <symbols>
      ...
      <symbol clip_to_extent="1" name="2" alpha="1" type="marker" force_rhr="0">
        <layer locked="0" pass="0" class="SvgMarker" enabled="1">
          ...
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="/var/www/html/TPI-GIS/EstilosDeCapas/imagenes/background_security.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" name="3" alpha="1" type="marker" force_rhr="0">
        <layer locked="0" pass="0" class="SvgMarker" enabled="1">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="/var/www/html/TPI-GIS/EstilosDeCapas/imagenes/accommodation_youth_hostel.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="35,35,35,255"/>
      ...
      <symbol clip_to_extent="1" name="4" alpha="1" type="marker" force_rhr="0">
        <layer locked="0" pass="0" class="SvgMarker" enabled="1">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="/var/www/html/TPI-GIS/EstilosDeCapas/imagenes/anchor.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
