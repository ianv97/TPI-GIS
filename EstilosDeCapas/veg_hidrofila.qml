...
<qgis version="3.8.2-Zanzibar" styleCategories="Symbology|Labeling" labelsEnabled="0">
  <renderer-v2 enableorderby="0" type="categorizedSymbol" symbollevels="0" forceraster="0" attr="tipo">
    <categories>
      <category label="Pajonal, Malezal, Cardal, Cortaderal, Españal, Jarillal, Quiscal, Juncal, Totoral" render="true" value="Pajonal, Malezal, Cardal, Cortaderal, Españal, Jarillal, Quiscal, Juncal, Totoral" symbol="0"/>
      <category label="" render="false" value="" symbol="1"/>
    </categories>
    <symbols>
      <symbol force_rhr="0" type="fill" clip_to_extent="1" alpha="1" name="0">
        <layer pass="0" enabled="1" class="PointPatternFill" locked="0">
          ...
          <symbol force_rhr="0" type="marker" clip_to_extent="1" alpha="1" name="@0@0">
      ...
      <symbol force_rhr="0" type="fill" clip_to_extent="1" alpha="1" name="1">
        <layer pass="0" enabled="1" class="PointPatternFill" locked="0">
          ...
          <symbol force_rhr="0" type="marker" clip_to_extent="1" alpha="1" name="@1@0">
            <layer pass="0" enabled="1" class="SvgMarker" locked="0">
              <prop k="angle" v="0"/>
